# Draft XI — developer guide

How Draft XI plays in full, and how it's built: running it, deploying it, the code layout and the data.
For what Draft XI is, start with the [README](../README.md).
